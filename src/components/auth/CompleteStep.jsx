...
export default function CompleteStep() {
  ...
  async function handleComplete() {
    ...
    // Set verified in store with a real (or fallback) uid
    useAuthStore.getState().setUser({ uid, fullName, verified: true })
    ...
    localStorage.setItem('nexus-auth', JSON.stringify({
      state: { uid, fullName, verified: true },
      version: 0,
    }))

    console.log('[CompleteStep] verified state before navigate:', useAuthStore.getState())
